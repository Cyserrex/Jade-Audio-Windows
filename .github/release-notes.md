...
- **Laid out as a mixer** — one vertical channel strip per band, side by side,
  with master gain and output volume as their own strips. Faders have a
  recessed groove, a tick scale and a capped thumb with a centre indicator
  line; gain faders mark their zero detent and carry no fill, since gain runs
  either side of zero.
